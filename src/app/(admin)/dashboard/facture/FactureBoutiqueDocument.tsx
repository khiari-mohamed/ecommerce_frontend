...
const FactureBoutiqueDocument = forwardRef(({ order, printRef }: { order: any, printRef?: any }, ref) => {
      ...
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl p-6 relative border border-blue-200 print:shadow-none print:border-none print:rounded-none print:p-0">
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex flex-col items-start">
            <Image src={COMPANY.logo} alt="Logo" width={100} height={40} className="h-12 mb-1" />
          ...
          <div className="flex flex-col items-end">
            <span className="text-2xl font-extrabold text-right" style={{ color: ORANGE, letterSpacing: "1px" }}>Facture Boutique</span>
...
FactureBoutiqueDocument.displayName = "FactureBoutiqueDocument";
export default FactureBoutiqueDocument;