...
const FactureBoutiqueList = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">Factures Boutique</h2>
      ...
      <FactureModal open={!!selectedOrder} onClose={() => setSelectedOrder(null)}>
        {selectedOrder && (
          <>
            <FactureBoutiqueDocument order={selectedOrder} />
...
export default FactureBoutiqueList;