...
const SingleItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-2 sm:px-7.5 min-w-[700px] sm:min-w-[1100px]">
      {/* Product */}
      <div className="flex items-center gap-4 sm:w-[35%] min-w-[180px]">
        <div className="min-w-[60px] max-w-[60px] h-[60px] flex items-center justify-center bg-gray-100 rounded-md overflow-hidden p-2 mr-2">
          <Image
            width={56}
            height={56}
            src={imgSrc}
      ...
      {/* Price */}
      <div className="flex items-center justify-center sm:w-[15%] min-w-[100px]">
        <p className="text-dark text-sm sm:text-base whitespace-nowrap text-center w-full">
          {Number(item.discountedPrice).toLocaleString("fr-TN", { style: "currency", currency: "TND" })}
        </p>
      </div>
      {/* Quantity */}
      <div className="flex items-center justify-center sm:w-[20%] min-w-[100px]">
      ...
      {/* Action */}
      <div className="flex items-center justify-center sm:w-[5%] min-w-[60px]">
        <button
