...
// Liste mondiale des pays (ISO 3166)
const COUNTRIES = [
  ...
  "Tadjikistan", "Tanzanie", "Tchad", "Tchéquie", "Thaïlande", "Timor oriental", "Togo", "Tonga", "Trinité-et-Tribago", "Tunisie", "Turkménistan", "Turquie", "Tuvalu",
...
// Shipping component is disabled as per simplification request
// const Shipping: React.FC<ShippingProps> = ({ value, onChange }) => {
//   ...
// };
