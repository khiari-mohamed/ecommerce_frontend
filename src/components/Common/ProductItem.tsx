  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[270px] mb-4">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex flex-row flex-nowrap items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0 overflow-x-auto !flex-row !flex-nowrap">
          <button
            onClick={() => {
              openModal();
