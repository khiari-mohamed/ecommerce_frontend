            ...
            <div className="w-full max-w-xl">
              ...
              <div className="flex flex-wrap items-center gap-5.5 mb-4.5">
                <div className="flex items-center gap-2.5">
                  ...
                  <span>({reviewsCount} avis client{reviewsCount !== 1 ? "s" : ""})</span>
                </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          />
                ...
                <div className="flex flex-wrap items-center gap-4.5">
                  ...
                  <button type="button" aria-label="Ajouter aux favoris" className="flex items-center justify-center w-12 h-12 rounded-md border border-gray-3 ease-out duration-200 hover:text-white hover:bg-dark hover:border-transparent">
