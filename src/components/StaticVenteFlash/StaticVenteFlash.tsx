    ...
    <section className="py-20 bg-gradient-to-b from-white to-red-50" aria-labelledby="flash-sales-title">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 id="flash-sales-title" className="text-4xl font-bold mb-2" style={{ color: 'rgb(255, 69, 0)' }}>
            {config.sectionTitle}
          </h2>
        ...
        <div className={`grid gap-8 ${
          ...
          {displayedProducts.map((product: any) => {
            ...
            return <FlashSaleCard key={product?._id || product?.id || Math.random()} product={safeProduct} />;
          })}
        </div>
      </div>
    </section>
