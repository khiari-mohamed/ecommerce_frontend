      ...
      <section className="overflow-hidden py-10 sm:py-16 md:py-20 bg-gray-2">
        <div className="max-w-full md:max-w-3xl lg:max-w-5xl xl:max-w-[1170px] w-full mx-auto px-2 sm:px-4 md:px-8 xl:px-0">
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-between gap-5 mb-7.5">
            <h2 className="font-medium text-dark text-xl sm:text-2xl mt-6">
  Votre liste de souhaits
          ...
          <div className="bg-white rounded-[10px] shadow-1">
            <div className="w-full overflow-x-auto">
              <div className="sm:min-w-[1100px]">
                {/* Table header */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center py-5 px-2 sm:px-4 md:px-7.5 text-xs sm:text-sm md:text-base border-b border-gray-3 w-full">
                  {/* Mobile: Only show labels */}
                  <div className="block sm:hidden w-full">
                    <p className="text-dark text-left font-semibold w-full">
                      Produit
                    </p>
                    <div className="flex flex-col mt-4 space-y-4">
                      <p className="text-dark text-left">Prix unitaire</p>
                      <p className="text-dark text-left">Statut du stock</p>
                  ...
                  <div className="hidden sm:flex w-full">
                    <div className="items-center sm:w-[35%] min-w-[180px] flex">
                      <p className="text-dark text-left whitespace-nowrap overflow-hidden text-ellipsis w-full">
                        Produit
                      </p>
                    </div>
                    <div className="items-center justify-center sm:w-[20%] min-w-[100px] flex">
                      <p className="text-dark text-center w-full">
                        Prix unitaire
                      </p>
                    </div>
                    <div className="items-center justify-center sm:w-[30%] min-w-[120px] flex">
                      <p className="text-dark text-center w-full">
                        Statut du stock
                      </p>
                    </div>
                    <div className="items-center justify-center sm:w-[15%] min-w-[80px] flex">
              ...
              {wishlistItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16">
                  ...
                  <p className="pb-6 text-gray-500 text-lg">
